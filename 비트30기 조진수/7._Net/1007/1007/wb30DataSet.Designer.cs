...
namespace _1007.wb30DataSetTableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Product] WHERE (([PID] = @Original_PID) AND ([PNAME] = @Origin" +
                "al_PNAME) AND ([Price] = @Original_Price) AND ((@IsNull_Description = 1 AND [Des" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Product] SET [PNAME] = @PNAME, [Price] = @Price, [Description] = @Description WHERE (([PID] = @Original_PID) AND ([PNAME] = @Original_PNAME) AND ([Price] = @Original_Price) AND ((@IsNull_Description = 1 AND [Description] IS NULL) OR ([Description] = @Original_Description)));
SELECT PID, PNAME, Price, Description FROM Product WHERE (PID = @PID)";
        ...
        public virtual int Fill(wb30DataSet.ProductDataTable dataTable) {
        ...
        public virtual wb30DataSet.ProductDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            wb30DataSet.ProductDataTable dataTable = new wb30DataSet.ProductDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(wb30DataSet.ProductDataTable dataTable) {
        ...
        public virtual int Delete(int Original_PID, string Original_PNAME, int Original_Price, string Original_Description) {
        ...
        public virtual int Update(string PNAME, int Price, string Description, int Original_PID, string Original_PNAME, int Original_Price, string Original_Description, int PID) {
            if ((PNAME == null)) {
                throw new global::System.ArgumentNullException("PNAME");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string PNAME, int Price, string Description, int Original_PID, string Original_PNAME, int Original_Price, string Original_Description) {
            return this.Update(PNAME, Price, Description, Original_PID, Original_PNAME, Original_Price, Original_Description, Original_PID);
        }
    }
