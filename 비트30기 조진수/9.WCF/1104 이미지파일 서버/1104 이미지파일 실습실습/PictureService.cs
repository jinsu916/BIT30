    ...
    class Service : PictureService
    {
        public byte[] GetPicture(string strFileName)
        {
            ...
            try
            {
             ...
             FileStream(@"C:\Users\bit\Desktop\비트30기 조진수\9.WCF\1104 이미지파일 서버\두루미\" + strFileName, FileMode.Open,
        ...
        public string[] GetPictureList()
        {
            ...
            string[] strPicList = Directory.GetFiles(@"C:\Users\bit\Desktop\비트30기 조진수\9.WCF\1104 이미지파일 서버\두루미\");
        ...
        public bool UploadPicture(string strFileName, byte[] bytePic)
        {
            try
            {
              ...
              @"C:\Users\bit\Desktop\비트30기 조진수\9.WCF\1104 이미지파일 서버\두루미\" + strFileName, FileMode.Create,
              FileAccess.Write);
